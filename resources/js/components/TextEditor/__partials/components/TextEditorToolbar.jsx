...
const TextEditorToolbar = ({ editor }) => {
    const buttons = [
        { command: 'toggleBold', isActive: editor.isActive('bold'), label: <strong>B</strong> },
        { command: 'toggleItalic', isActive: editor.isActive('italic'), label: <i>I</i> },
        { command: 'toggleUnderline', isActive: editor.isActive('underline'), label: <u>U</u> },
        {
